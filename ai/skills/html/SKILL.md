...
Create a single, self-contained HTML file for the requested subject, optimized for a first-time reader. They may not have read the underlying code, document, or data — they should be able to understand and review it from the artifact alone. Optimize for easy reading and digestion. Default to light mode.
